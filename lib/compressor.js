...
var Compressor = function(err, data, root, params) {
  this.params = params;
  this.root = root;
  this.srcScripts = [];
  this.srcStyles = [];
  ...
  garbage = garbage.concat(_.difference(this.prependFolderToFiles('css', this.compressedSnapshot.css), this.srcStyles));
  garbage = garbage.concat(_.difference(this.prependFolderToFiles('js', this.compressedSnapshot.js), this.srcScripts));
...
Compressor.prototype = {
  copyPage: function() {
    ...
    var pathfile = path.join(this.root, '.compressed', path.basename(file));
  ...
  createDirectories: function(callback) {
    ...
    this.compressedSnapshot.css = this.readdir(cssdir, 'css');
    this.compressedSnapshot.js = this.readdir(jsdir, 'js');
  ...
  createMinifyJs: function(scripts) {
    var rootedScripts = this.prependFolderToFiles(this.root, scripts);
