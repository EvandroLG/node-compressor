...
Compressor.prototype = {
  ...
  removeCacheFiles: function() {
    ...
    var diff = function(type) {
      var property = type === 'js' ? 'srcScripts' : 'srcStyles';

      _.difference(this.prependFolderToFiles(type, 
                   this.compressedSnapshot[type]), this[property]);
    };

    garbage = garbage.concat(diff('css'));
    garbage = garbage.concat(diff('js'));
